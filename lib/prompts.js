...
INPUT LANGUAGE: The citizen may write in ANY language or mixed language style — including Hinglish (Hindi+English), Tanglish (Tamil+English), Benglish (Bengali+English), Tenglish (Telugu+English), or any other Indian language mix. Understand the question regardless of how it is written.

OUTPUT LANGUAGE: You MUST always respond in ${LANG_NAMES[lang] || 'English'} only, regardless of what language the citizen used to ask the question.
...
OUTPUT LANGUAGE: You MUST always respond in ${LANG_NAMES[details.lang] || 'English'} only.
...
INPUT LANGUAGE: The citizen may describe the issue in ANY language or mixed style (Hinglish, Tanglish, Benglish, etc.). Understand it regardless of how it is written.

OUTPUT LANGUAGE: You MUST write the formal complaint in ${LANG_NAMES[lang] || 'English'} only.
